...
class ManualePage(QWidget):
    ...
    def _build(self):
        ...
        # Placeholder “Fuori Quota” (stesse dimensioni del pannello in altre pagine)
    ...
    # ---------------- Lifecycle ----------------
    def on_show(self):
        # Abilita lettura pulsante TESTA solo qui
        try:
    ...
    def hideEvent(self, ev):
        ...
        # Reinserisce sempre la frizione all'uscita
        try:
