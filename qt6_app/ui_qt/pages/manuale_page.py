...
class ManualePage(QWidget):
    def __init__(self, appwin):
        ...
        self._btn_main_min_w: int = 0   # larghezza fissa FRENO/FRIZIONE (da “Sblocca Freno”)
